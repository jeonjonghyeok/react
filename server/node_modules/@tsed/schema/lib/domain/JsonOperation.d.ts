import { OpenSpecSecurity, OpenSpecTag, OS3Operation } from "@tsed/schema/lib/domain/node_modules/@tsed/openspec";
import { JsonHeader, JsonSchemaOptions } from "@tsed/schema/lib/interfaces";
import { JsonMap } from "@tsed/schema/lib/domain/JsonMap";
import { JsonParameter } from "@tsed/schema/lib/domain/JsonParameter";
import { JsonResponse } from "@tsed/schema/lib/domain/JsonResponse";
import { JsonSchema } from "@tsed/schema/lib/domain/JsonSchema";
