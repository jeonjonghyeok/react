import { Container } from "@tsed/di/lib/class/Container";
import { LocalsContainer } from "@tsed/di/lib/class/LocalsContainer";
import { Provider } from "@tsed/di/lib/class/Provider";
import { IDILogger, IInjectablePropertyService, IInjectablePropertyValue, InvokeOptions, IProvider, ProviderScope, TokenProvider } from "@tsed/di/lib/interfaces";
import { DIConfiguration } from "@tsed/di/lib/services/DIConfiguration";
/**
...
export declare class InjectorService extends Container {
    ...
    constructor();
    get resolvers(): import("@tsed/di/lib/interfaces").IDIResolver[];
    get scopes(): {
     ...
     * @param invokeOptions
     */
    bindProperty(instance: any, { propertyKey, useType, options }: IInjectablePropertyService, locals: Map<TokenProvider, any>, invokeOptions: Partial<InvokeOptions>): void;
    /**
     *
     * @param instance
     * @param {string} propertyKey
