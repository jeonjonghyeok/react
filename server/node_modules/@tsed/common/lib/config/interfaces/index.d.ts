...
import { Env, Type } from "@tsed/common/lib/config/interfaces/node_modules/@tsed/core";
import * as Https from "https";
import { ConverterSettings } from "@tsed/common/lib/config/interfaces/ConverterSettings";
import { EndpointDirectoriesSettings } from "@tsed/common/lib/config/interfaces/EndpointDirectoriesSettings";
import { PlatformLoggerSettings } from "@tsed/common/lib/config/interfaces/PlatformLoggerSettings";
import { PlatformMulterSettings } from "@tsed/common/lib/config/interfaces/PlatformMulterSettings";
import { PlatformStaticsSettings } from "@tsed/common/lib/config/interfaces/PlatformStaticsSettings";
import { PlatformViewsSettings } from "@tsed/common/lib/config/interfaces/PlatformViewsSettings";
import { ResponseFilterMethods } from "@tsed/common/lib/platform-response-filter/interfaces/ResponseFilterMethods";
declare global {
    namespace TsED {
...
export * from "@tsed/common/lib/config/interfaces/PlatformLoggerSettings";
export * from "@tsed/common/lib/config/interfaces/EndpointDirectoriesSettings";
export * from "@tsed/common/lib/config/interfaces/PlatformStaticsSettings";
export * from "@tsed/common/lib/config/interfaces/PlatformMulterSettings";
