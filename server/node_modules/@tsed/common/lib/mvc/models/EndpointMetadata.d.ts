import { Type } from "@tsed/common/lib/mvc/models/node_modules/@tsed/core";
import { JsonEntityStore, JsonEntityStoreOptions, JsonOperation } from "@tsed/common/lib/mvc/models/node_modules/@tsed/schema";
import { ParamMetadata } from "@tsed/common/lib/mvc/models/ParamMetadata";
...
export declare class EndpointMetadata extends JsonEntityStore implements EndpointConstructorOptions {
    ...
    get operationPaths(): Map<string, import("@tsed/common/lib/mvc/models/node_modules/@tsed/schema").JsonMethodPath>;
