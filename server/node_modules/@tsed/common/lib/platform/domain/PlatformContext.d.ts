...
import { InjectorService, LocalsContainer } from "@tsed/common/lib/platform/domain/node_modules/@tsed/di";
import { IncomingMessage, ServerResponse } from "http";
import { EndpointMetadata } from "@tsed/common/lib/mvc/models/EndpointMetadata";
import { PlatformApplication } from "@tsed/common/lib/platform/services/PlatformApplication";
import { PlatformRequest } from "@tsed/common/lib/platform/services/PlatformRequest";
import { PlatformResponse } from "@tsed/common/lib/platform/services/PlatformResponse";
import { RequestLogger, RequestLoggerOptions } from "@tsed/common/lib/platform/domain/RequestLogger";
...
export declare class PlatformContext extends Map<any, any> {
    ...
    get env(): import("@tsed/common/lib/platform/domain/node_modules/@tsed/core").Env;
