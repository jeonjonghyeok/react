import { Type } from "@tsed/common/lib/platform-builder/builder/node_modules/@tsed/core";
import { Container, InjectorService, IProvider } from "@tsed/common/lib/platform-builder/builder/node_modules/@tsed/di";
import { IRoute, Platform, PlatformApplication } from "@tsed/common/lib/platform";
/**
 * @ignore
 */
...
export declare abstract class PlatformBuilder {
     ...
     */
    get settings(): TsED.Configuration & import("@tsed/common/lib/platform-builder/builder/node_modules/@tsed/di").DIConfiguration;
    get logger(): import("@tsed/common/lib/platform-builder/builder/node_modules/@tsed/di").IDILogger;
